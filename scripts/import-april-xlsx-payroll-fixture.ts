...
function buildPayslipInputs(row: unknown[]): PayslipPayrollInputs {
  return {
    ...
    cloth: numberCell(row, 75),
    clothAdj: numberCell(row, 76),
    emplach: numberCell(row, 77),
    emplachAdj: numberCell(row, 78),
    holrep: numberCell(row, 79),
    holrepAdj: numberCell(row, 80),
    laundry: numberCell(row, 81),
    laundryAdj: numberCell(row, 82),
    medasst: numberCell(row, 83),
    medasstAdj: numberCell(row, 84),
    medcash: numberCell(row, 85),
    medcashAdj: numberCell(row, 86),
    otmeal: numberCell(row, 87),
