  ...
  async function handleDownloadPdf() {
    ...
    try {
      const response = await fetch(
        `/payslips/${encodeURIComponent(selectedPayslip.id)}/pdf`,
        {
          method: "POST",
      ...
      link.href = url
      link.download = getDownloadFilename(response, selectedPayslip)
      ...
      toast.success("Payslip PDF downloaded", {
        description: selectedPayslip.payrollPeriodLabel,
      })
    } finally {
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      ...
                      {selectedPayslip.payrollPeriodLabel}. Enter your current
                      portal password to lock and open the PDF.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
